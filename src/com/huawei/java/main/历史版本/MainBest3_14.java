...
//        // 处理每一天的请求
//        for (List<Request> list : requestLists) {
...
//                    int num1 = curVirtualUsedMap.size();
...
//     * 该怎么购买
//     */
//    public static void expansion(Virtual curVirtual, Request request, PriorityQueue<Server> serverListSelected) {
//        if(curVirtual.isBi==1){
